<%@page import="com.sample.hr.dao.DepartmentDaoMybatis"%>
...
<body>
	...
	<%
		...
		DepartmentDaoMybatis dao = DepartmentDaoMybatis.getInstance();
		DepartmentDto dto = dao.getDepartmentDto(departmentId);
